...
training_embeddings_file = "/Genomics/ayroleslab2/scott/git/lts-manuscript/analysis/20230524-mmpy-lts-all-pchip5-headprobinterp-medianwin5-gaussian-lombscargle-dynamicwinomega020-training/UMAP/training_embedding.mat"
...
# density_copy[density_copy < 1e-3] = 0
wshed = watershed(-density_copy, connectivity=10)
wshed[density_copy < 1e-3] = 0
...
plt.savefig("figures/tmp/20230526_training_density_sigma1_segmented.png")
plt.close()
